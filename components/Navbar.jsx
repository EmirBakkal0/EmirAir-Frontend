    ...
    <nav className="w-full z-50 bg-white/80 dark:bg-slate-900/80 backdrop-blur-xl shadow-sm dark:shadow-none">
        <div className="flex justify-between items-center h-20 px-8 max-w-screen-2xl mx-auto font-['Manrope'] tracking-tight">
          ...
          <div className="hidden md:flex items-center gap-8">
            <Link className={isActive("/") ? "text-blue-600 dark:text-blue-400 font-bold border-b-2  border-blue-600 transition-colors duration-300" : "text-slate-600 dark:text-slate-400 font-medium hover:text-blue-500 transition-colors duration-300"} href="/">
              Explore
            </Link>
