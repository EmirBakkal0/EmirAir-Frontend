      ...
      <footer className="w-full py-12 mt-auto bg-slate-50 dark:bg-slate-950 border-t border-slate-200 dark:border-slate-800/20">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:flex lg:justify-between px-8 max-w-screen-2xl mx-auto">
          ...
          <div className="flex flex-wrap gap-8">
            <a className="text-slate-500 dark:text-slate-400 text-sm font-['Inter'] hover:underline hover:text-blue-500" href="#">Privacy Policy</a>
            <a className="text-slate-500 dark:text-slate-400 text-sm font-['Inter'] hover:underline hover:text-blue-500" href="#">Terms of Service</a>
            <a className="text-slate-500 dark:text-slate-400 text-sm font-['Inter'] hover:underline hover:text-blue-500" href="#">Cookie Settings</a>
            <a className="text-slate-500 dark:text-slate-400 text-sm font-['Inter'] hover:underline hover:text-blue-500" href="#">Accessibility</a>
          </div>
        </div>
      </footer>
    </div>
